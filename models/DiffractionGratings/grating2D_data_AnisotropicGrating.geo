...
// grating2D_data_AnisotropicGrating.geo //
////////////////////////////////////////////
...
DefineConstant[
  d           = {600 , Name StrCat[pp0  , "0grating period [nm]"]          , Highlight Str[colorpp]  , Closed close_menu} , 
  h_sub  		  = {1000 , Name StrCat[pp01 , "1substrate thickness [nm]"]     , Highlight Str[colorpp01], Closed close_menu},
  ...
  h_sup  		  = {1000, Name StrCat[pp01 , "4superstrate thickness [nm]"]   , Highlight Str[colorpp01], Closed close_menu},
  ...
  w_rod_bot   	       = { 500, Name StrCat[pp02, "3bottom rod width if trapz rod OR x-diameter if elliptic rod [nm]"]         , Highlight Str[colorpp02], Closed close_menu},
  w_rod_top	           = { 300, Name StrCat[pp02, "4top rod width if trapz rod [nm]"]         , Highlight Str[colorpp02], Closed close_menu},
  h_rod                = { 600, Name StrCat[pp02 ,"5rod thickness if trapz rod OR y-diameter if elliptic rod [nm]"]     , Highlight Str[colorpp02], Closed close_menu},
  dy        	         = { 700, Name StrCat[pp02 ,"6embedding layer thickness OR 'period' along y if number of rods >1, [nm]"]    , Highlight Str[colorpp02], Closed close_menu},    
  ...
  flag_mat_2  = {13 , Name StrCat[pp1, "0Dispersive materials/1material deposit layer"] , Choices {0="Air",1="SiO2",2="Ag (palik)",3="Al (palik)",4="Au (johnson)",5="Nb2O5",6="ZnSe",7="MgF2",8="TiO2",9="PMMA",10="Si",11="ITO",12="Cu (palik)",13="custom 1 (lossless)",14="custom 2",15="custom 3"} },
  flag_mat_3  = {0  , Name StrCat[pp1, "0Dispersive materials/2material embedding rods"], Choices {0="Air",1="SiO2",2="Ag (palik)",3="Al (palik)",4="Au (johnson)",5="Nb2O5",6="ZnSe",7="MgF2",8="TiO2",9="PMMA",10="Si",11="ITO",12="Cu (palik)",13="custom 1 (lossless)",14="custom 2",15="custom 3"} },
  flag_mat_4  = {15 , Name StrCat[pp1, "0Dispersive materials/3material rods"]          , Choices {0="Air",1="SiO2",2="Ag (palik)",3="Al (palik)",4="Au (johnson)",5="Nb2O5",6="ZnSe",7="MgF2",8="TiO2",9="PMMA",10="Si",11="ITO",12="Cu (palik)",13="custom 1 (lossless)",14="custom 2",15="custom 3"} },
  ...
  epsr_custom_1_re  = { 2.25    , Name StrCat[pp1 , "1Custom non-dispersive materials/0custom relative permittivity 1 (real part)"] , Highlight Str[colorpp]  , Closed 0} , 
  epsr_custom_1_im  = { 0       , Name StrCat[pp1 , "1Custom non-dispersive materials/1custom relative permittivity 1 (imag part)"] , ReadOnly 1, Highlight Str[colorro]  , Closed 0} ,
  epsr_custom_2_re  = {-44.9757 , Name StrCat[pp1 , "1Custom non-dispersive materials/2custom relative permittivity 2 (real part)"] , Highlight Str[colorpp]  , Closed 0} , 
  epsr_custom_2_im  = {-2.9524  , Name StrCat[pp1 , "1Custom non-dispersive materials/3custom relative permittivity 2 (imag part)"] , Highlight Str[colorpp]  , Closed 0} , 
  epsr_custom_3_re  = { 2.829   , Name StrCat[pp1 , "1Custom non-dispersive materials/4custom relative permittivity 3 (real part)"] , Highlight Str[colorpp]  , Closed 0} , 
  epsr_custom_3_im  = {   0     , Name StrCat[pp1 , "1Custom non-dispersive materials/5custom relative permittivity 3 (imag part)"] , Highlight Str[colorpp]  , Closed 0} , 
  
  Flag_aniso              = {       1 , Name StrCat[pp2b , "0Enable anisotropy for rods? (overrides material rods above)"] , Choices {0,1} ,Closed 0} ,
  epsr_custom_anisoXX_re  = {   2.592 , Name StrCat[pp2b , "1 epsilonr XX re"] , Highlight Str[colorpp]                                   , Closed 0} , 
  epsr_custom_anisoXX_im  = {   0     , Name StrCat[pp2b , "2 epsilonr XX im"] , Highlight Str[colorpp]                                   , Closed 0} , 
  epsr_custom_anisoYY_re  = {   2.592 , Name StrCat[pp2b , "3 epsilonr YY re"] , Highlight Str[colorpp]                                   , Closed 0} , 
  epsr_custom_anisoYY_im  = {   0     , Name StrCat[pp2b , "4 epsilonr YY im"] , Highlight Str[colorpp]                                   , Closed 0} , 
  epsr_custom_anisoZZ_re  = {   2.829 , Name StrCat[pp2b , "5 epsilonr ZZ re"] , Highlight Str[colorpp]                                   , Closed 0} , 
  epsr_custom_anisoZZ_im  = {   0     , Name StrCat[pp2b , "6 epsilonr ZZ im"] , Highlight Str[colorpp]                                   , Closed 0} , 
  epsr_custom_anisoXY_re  = {   0.251 , Name StrCat[pp2b , "7 epsilonr XY re"] , Highlight Str[colorpp]                                   , Closed 0} , 
  epsr_custom_anisoXY_im  = {   0     , Name StrCat[pp2b , "8 epsilonr XY im"] , Highlight Str[colorpp]                                   , Closed 0} , 
