...
Function{
  ...
  For i In {1:NumMagnets}
    ...
    DefineConstant[
      HC~{i} = {800e3,        Name Sprintf("Parameters/Magnet %g/0Coercive magnetic field [Am^-1]", i)},
      //HC~{i} = {800e4,        Name Sprintf("Parameters/Magnet %g/0Coercive magnetic field [Am^-1]", i)},
      BR~{i} = {mu0 * HC~{i}, Name Sprintf("Parameters/Magnet %g/0Remnant magnetic flux density [T]", i),
        ReadOnly 1}
    ];
