...
mm = 1.e-3;
//radius = 0.0201604646760 * 4.863703305156;
//height = 20 * mm;

// MY MAGNET DIAMETER AND HEIGHT ARE 9*3MM
// radius = 0.0045 *  4.863703305156 * 0.803192144613; // ratio: 4.863703305156; density: 0.803192144613, http://hydra.nat.uni-magdeburg.de/packing/cci/cci56.html
radius = 0.01961504524593303;
height = 0.003;
